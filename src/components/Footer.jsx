  ...
  return (
    <section className="flex flex-col gap-8 md:flex-row md:justify-between px-6 pb-10  items-center justify-center">
      ...
      <div className="mt-3 gap-6 flex text-gray-500 md:order-2">
        <img className="size-6" src="./src/images/icon-twitter.svg" alt="" />
        <img className="size-6" src="./src/images/icon-youtube.svg" alt="" />
        <img className="size-6" src="./src/images/icon-linkedin.svg" alt="" />
        <img className="size-6" src="./src/images/icon-instagram.svg" alt="" />
      </div>
